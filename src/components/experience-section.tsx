...
export default function ExperienceSection() {
  return (
    <section id="experience" className="bg-card animate-fade-in-up" style={{ animationDelay: "0.9s" }}>
      <div className="container">
        ...
        <div className="grid gap-12 md:grid-cols-2">
          <div className="animate-fade-in-up" style={{ animationDelay: "1s" }}>
            ...
            <div className="relative space-y-8 pl-6 before:absolute before:inset-y-0 before:w-0.5 before:bg-border before:left-0">
              {experienceData.map((exp, index) => (
                <div key={index} className="relative animate-fade-in-up" style={{ animationDelay: `${index * 150 + 1100}ms` }}>
                  <div className="absolute -left-[37px] top-1.5 h-4 w-4 rounded-full bg-accent animate-pulse" />
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "1.2s" }}>
            ...
            <Card className="animate-zoom-in" style={{ animationDelay: "1.3s" }}>
